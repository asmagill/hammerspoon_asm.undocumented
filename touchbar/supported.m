...
// "hs._asm.undocumented.touchbar.supported" function.
//
// If we don't do it this way, loading "hs._asm.undocumented.touchbar.internal" causes an unresolved
...
int luaopen_hs__asm_undocumented_touchbar_supported(lua_State* __unused L) {
    LuaSkin *skin = [LuaSkin shared] ;
